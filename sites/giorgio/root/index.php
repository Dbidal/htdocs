...
<div class="wp-block-group has-background head" style="background-color:#20202f;background-color:#20202fff;position:sticky;left:0;right:0;top:0;z-index:4;bottom:auto" data-unique-id="0un6evkyx">
	...
	<style>
		...
		@media (max-width:600px) {
			div.hcube-content [data-unique-id="0un6evkyx"],
			[data-unique-id="0un6evkyx"] * {text-align: center;}
			div.hcube-content [data-unique-id="0un6evkyx"] .wp-block-button {margin: 0px 10px 20px 10px;float: none;display: inline-block;}
			div.hcube-content [data-unique-id="0un6evkyx"] .wp-block-button.aligncenter {margin-left: 0px;margin-right: 0px;}
		}
	</style>
</div>
			...
			<div class="wp-block-group__inner-container">
				...
				<div style="padding-left:20px;padding-right:20px">
					<div style="font-size: 48px;">
						<h2 class="has-text-color has-text-align-center" style="color:#ffffff">GIORGIO CONSTRUCTION INC.</h2>
					</div>
				</div>
				<p style="color:#ffffff;margin-top:0;" class="has-text-color has-text-align-center has-medium-font-size">SPECIALIZING IN WATERPROOFING</p>
				<div style="height:100px" aria-hidden="true" class="wp-block-spacer"></div>
			</div>
			<style>
				div.hcube-content [data-unique-id="p95x7xatx"] {padding-top: 7vw;padding-bottom: 7vw;}
			</style>
		</div>
	</div>
	<style>
		div.hcube-content [data-unique-id="zekobe525"] {width: 100%;max-width: 100%;}
		div.hcube-content [data-unique-id="zekobe525"]>div {max-width: 100%;}
	</style>
</div>
<style>
	.head .wp-block-group {overflow: auto;}
	.top {padding-top: 3px;}
	.reviews p {font-size: 14px;}
	.reviews blockquote {margin: 20px;}
	.head figure {margin: 0;}
	.cover:before {background: linear-gradient(360deg, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0) 80%);content: '';height: 100%;width: 100%;position: absolute;z-index: 1;}
	.cover>*>.wp-block-group {z-index: 2;position: relative;}
	.head:not(#_):not(#_):not(#_):not(#_):not(#_):not(#_) {z-index: 3;}
	@media(max-width:700px) {.head:not(#_) figure {display: none;}}
</style>
<div style="height:60px" aria-hidden="true" class="wp-block-spacer"></div>
<h2>Contact Us Today!</h2>
<p style="">Email: <a href="mailto:giorgioconstructioninc@gmail.com">giorgioconstructioninc@gmail.com</a><br>Phone: <a href="tel:(807) 631-4004">(807) 631-4004</a></p>
<div class="wp-block-columns" data-unique-id="3p1u01rxn">
	...
	<div class="hcube-block-column" style="flex-basis:60%">
		<div class="wp-block-group" data-unique-id="xjex9uson">
			<div class="wp-block-group__inner-container">
				<div class="wp-block-group" data-unique-id="junajft8g">
					<div class="wp-block-group__inner-container">
						<div class="wp-block-group" data-unique-id="o9yc6ar46">
							<div class="wp-block-group__inner-container">
								<div style="height:60px" aria-hidden="true" class="wp-block-spacer"></div>
								<h2>What We Do</h2>
								<ul>
			...
			<style>
				div.hcube-content [data-unique-id="xjex9uson"] {margin-top: -20px;margin-left: 20px;margin-right: 20px;margin-bottom: 0;}
			</style>
		</div>
	</div>
	<style>
		@media (max-width:780px) {[data-unique-id="3p1u01rxn"] {flex-wrap: wrap;}
			[data-unique-id="3p1u01rxn"]>div {flex-basis: 100% !important;margin-left: 0px !important;}
			[data-unique-id="3p1u01rxn"]>div:nth-child(1) {order: 2;}
			[data-unique-id="3p1u01rxn"]>div:nth-child(2) {order: 1;}
			[data-unique-id="3p1u01rxn"]>div:nth-child(3) {order: 3;}
			[data-unique-id="3p1u01rxn"]>div:nth-child(4) {order: 4;}
			[data-unique-id="3p1u01rxn"]>div:nth-child(5) {order: 5;}
			[data-unique-id="3p1u01rxn"]>div:nth-child(6) {order: 6;}
		}
	</style>
</div>
<div style="height:60px" aria-hidden="true" class="wp-block-spacer"></div>
<div class="wp-block-group has-background" style="background-color:#e8eaeb;background-color:#e8eaebff" data-unique-id="9zzkxccgl">
	<div class="wp-block-group__inner-container">
		<div class="wp-block-group__inner-container">
			<div style="height:60px" aria-hidden="true" class="wp-block-spacer"></div>
			<h2>Testimonials</h2>
							...
							<div class="wp-block-group__inner-container">
								<div class="wp-block-group__inner-container">
									<div class="wp-block-columns" data-unique-id="vc3344pwj">
										...
										<style>
											@media (max-width:850px) {[data-unique-id="vc3344pwj"] {flex-wrap: wrap;}
												[data-unique-id="vc3344pwj"]>div {flex-basis: 100% !important;margin-left: 0px !important;}
											}
										</style>
									</div>
								</div>
		...
		<style>
			div.hcube-content [data-unique-id="9zzkxccgl"] {width: 100%;max-width: 100%;}
		</style>
	</div>
</div>
<div class="wp-block-group has-background head" style="background-color:#dadada;background-color:#dadadaff" data-unique-id="cfi4ffxel">
	<div class="wp-block-group__inner-container">
		<div style="height:20px" aria-hidden="true" class="wp-block-spacer"></div>
	</div>
	<style>
		div.hcube-content [data-unique-id="cfi4ffxel"] {width: 100%;max-width: 100%;}
		@media (max-width:600px) {
			div.hcube-content [data-unique-id="cfi4ffxel"],
			[data-unique-id="cfi4ffxel"] * {text-align: center;}
			div.hcube-content [data-unique-id="cfi4ffxel"] .wp-block-button {margin: 0px 10px 20px 10px;float: none;display: inline-block;}
			div.hcube-content [data-unique-id="cfi4ffxel"] .wp-block-button.aligncenter {margin-left: 0px;margin-right: 0px;}
		}
	</style>
</div>
<div class="wp-block-group has-background head" style="background-color:#20202f;background-color:#20202fff" data-unique-id="e140d9ai4">
	<div class="wp-block-group__inner-container">
		<div class="wp-block-columns" data-unique-id="9m6buunvw">
			<div class="hcube-block-column" style="flex-basis:50%">
				<p style="color:#ffffff;font-size:26px;margin-top:20px;margin-bottom:0" class="has-text-color top"><strong>GIORGIO CONSTRUCTION&nbsp;INC.</strong></p>
				<p style="color:#ffffff;margin-top:0;margin-bottom:0" class="has-text-color">SPECIALIZING IN WATERPROOFING</p>
			</div>
			<div class="hcube-block-column" style="flex-basis:50%;align-self:center">
				<h4 class="has-text-color" style="color:#a7a7a7;margin-top:20px;margin-bottom:10px">Contact Us</h4>
				<p style="color:#a7a7a7;font-size:14px;margin-top:10px;" class="has-text-color">Email: <a href="mailto:giorgioconstructioninc@gmail.com">giorgioconstructioninc@gmail.com</a><br>Phone: <a href="tel:(807) 631-4004">(807) 631-4004</a></p>
			</div>
			<style>
				@media (max-width:599px) {[data-unique-id="9m6buunvw"] {flex-wrap: wrap;}
					[data-unique-id="9m6buunvw"]>div {flex-basis: 100% !important;margin-left: 0px !important;}
				}
			</style>
		</div>
	</div>
	<style>
		div.hcube-content [data-unique-id="e140d9ai4"] {width: 100%;max-width: 100%;}
		@media (max-width:800px) {
			div.hcube-content [data-unique-id="e140d9ai4"],
			[data-unique-id="e140d9ai4"] * {text-align: center;}
			div.hcube-content [data-unique-id="e140d9ai4"] .wp-block-button {margin: 0px 10px 20px 10px;float: none;display: inline-block;}
			div.hcube-content [data-unique-id="e140d9ai4"] .wp-block-button.aligncenter {margin-left: 0px;margin-right: 0px;}
		}
		div.hcube-content [data-unique-id="e140d9ai4"] {padding-top: 20px;padding-bottom: 20px;}
	</style>
</div>
<div class="wp-block-group has-background head" style="background-color:#171717;background-color:#171717ff" data-unique-id="btz43hmgd">
	<div class="wp-block-group__inner-container">
		<p style="color:#a7a7a7;" class="has-text-color has-text-align-center has-small-font-size">Copyright <?php echo date("Y"); ?> Giorgio Construction Inc. | Developed by <a href="http://dentalgrowthstrategies.com/">Dental Growth Strategies</a></p>
	</div>
	<style>
		div.hcube-content [data-unique-id="btz43hmgd"] {width: 100%;max-width: 100%;}
		@media (max-width:600px) {
			div.hcube-content [data-unique-id="btz43hmgd"],
			[data-unique-id="btz43hmgd"] * {text-align: center;}
			div.hcube-content [data-unique-id="btz43hmgd"] .wp-block-button {margin: 0px 10px 20px 10px;float: none;display: inline-block;}
			div.hcube-content [data-unique-id="btz43hmgd"] .wp-block-button.aligncenter {margin-left: 0px;margin-right: 0px;}
		}
	</style>
</div>
